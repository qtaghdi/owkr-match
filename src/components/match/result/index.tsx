        ...
        <div className="space-y-4">
            ...
            {alternatives.length > 0 && (
                <div className="space-y-2 px-1">
                    <div className="text-sm text-slate-500">다른 후보 조합</div>
